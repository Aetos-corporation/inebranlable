...
class Ui_EnvoiCommande(object):
    def setupUi(self, EnvoiCommande):
        EnvoiCommande.setObjectName("EnvoiCommande")
        EnvoiCommande.resize(426, 146)
        EnvoiCommande.setStyleSheet("QWidget\n"
"{\n"
...
"\n"
"")
        self.centralwidget = QtWidgets.QWidget(EnvoiCommande)
        self.centralwidget.setObjectName("centralwidget")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(40, 20, 271, 31))
        font = QtGui.QFont()
        font.setPointSize(15)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.lineEdit_send_command = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_send_command.setGeometry(QtCore.QRect(60, 70, 211, 22))
        self.lineEdit_send_command.setObjectName("lineEdit_send_command")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(310, 65, 93, 28))
        self.pushButton.setObjectName("pushButton")
        EnvoiCommande.setCentralWidget(self.centralwidget)
        self.statusbar = QtWidgets.QStatusBar(EnvoiCommande)
        self.statusbar.setObjectName("statusbar")
        EnvoiCommande.setStatusBar(self.statusbar)

        self.retranslateUi(EnvoiCommande)
        QtCore.QMetaObject.connectSlotsByName(EnvoiCommande)

    def retranslateUi(self, EnvoiCommande):
        _translate = QtCore.QCoreApplication.translate
        EnvoiCommande.setWindowTitle(_translate("EnvoiCommande", "MainWindow"))
        self.label.setText(_translate("EnvoiCommande", "Commande à envoyer :"))
        self.pushButton.setText(_translate("EnvoiCommande", "Envoyer"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    EnvoiCommande = QtWidgets.QMainWindow()
    ui = Ui_EnvoiCommande()
    ui.setupUi(EnvoiCommande)
    EnvoiCommande.show()
    sys.exit(app.exec())
